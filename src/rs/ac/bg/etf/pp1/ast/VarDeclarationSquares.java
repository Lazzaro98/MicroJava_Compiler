...
public class VarDeclarationSquares extends VarDecl {

    private Type Type;
    private String varName;
    private VarDeclListPom VarDeclListPom;

    public VarDeclarationSquares (Type Type, String varName, VarDeclListPom VarDeclListPom) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclarationSquares(\n");
